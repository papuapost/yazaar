MY.Phonebook = function() {
	return this.init();
}	
	
MY.Phonebook.LOCAL_DATA = { 
	result : [
...
MY.Phonebook.RESPONSE_SCHEMA = {
        fields: ["entry_key","last_name","first_name","extension","username","hired","hours","editor"]
};            

MY.Phonebook.prototype.init = function() {
    var oSelf = object(FlevBase);
    
    oSelf.oColumnHeaders = this.COLUMN_HEADERS;
    oSelf.oResponseSchema = this.RESPONSE_SCHEMA;
    oSelf.oConfigs = this.CONFIGS;
    oSelf.sDataTable = "elDataTable";
    oSelf.sTabView = "elTabView";
    oSelf.sDataForm = "elDataForm";
    oSelf.sListForm = "elForm";
    oSelf.sItemName = "last_name";
    
    return oSelf;
};
YAHOO.augment(MY.Phonebook, YAHOO.util.EventProvider);
